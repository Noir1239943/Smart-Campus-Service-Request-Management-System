...
export default function RequestOverviewSection({ request }: RequestOverviewSectionProps) {
  return (
    <Card>
      <CardBody className="space-y-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h2 className="mt-1 font-display text-xl font-semibold text-ink">{request.subject || request.type}</h2>
          </div>
