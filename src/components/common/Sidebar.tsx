...
import { LayoutDashboard, FileText, PlusCircle, Bell, Settings, X, LogOut, type LucideIcon } from 'lucide-react'
      ...
      >
        ...
        <div className="space-y-3 border-t border-border p-4">
          <div className="rounded-lg bg-navy-tint px-3.5 py-3">
            ...
            <p className="mt-0.5 text-xs text-navy/70">Visit the Help Desk on the 2nd floor, Admin Building.</p>
          </div>
          <button
